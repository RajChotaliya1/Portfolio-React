...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col-reverse md:flex-row items-center justify-between relative z-10 text-center md:text-left gap-10 md:gap-15">
        {/* LEFT TEXT SECTION */}
        <motion.div
        ...
        >
          ...
          <motion.p
            className="text-lg md:text-2xl text-gray-300 mb-8 max-w-2xl mx-auto md:mx-0"
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            {[
              { Icon: Github, href: "https://github.com/RajChotaliya1" },
              {
                Icon: Linkedin,
                href: "https://www.linkedin.com/in/raj-chotaliya-931527270/",
              },
              { Icon: Mail, href: "mailto:chotaliyaraj5@gmail.com" },
            ].map(({ Icon, href }, index) => (
              <motion.a
                key={index}
                href={href}
